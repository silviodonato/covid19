...
dataISTAT, dates = fillDataISTATpickle('dataISTAT/comuni_giornaliero_30settembre.csv',                                                                                      zerosuppression=1000, pickleFileName = "temp_italia_30settembre.pkl", writePickle = True)
